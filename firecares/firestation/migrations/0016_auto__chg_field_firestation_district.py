...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FireStation.district'
        db.alter_column(u'firestation_firestation', 'district', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True))

    def backwards(self, orm):

        # Changing field 'FireStation.district'
        db.alter_column(u'firestation_firestation', 'district', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True))
