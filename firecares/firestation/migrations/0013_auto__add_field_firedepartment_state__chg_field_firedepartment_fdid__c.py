...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FireDepartment.state'
        db.add_column(u'firestation_firedepartment', 'state',
                      self.gf('django.db.models.fields.CharField')(default='VA', max_length=2),
                      keep_default=False)


        # Changing field 'FireDepartment.fdid'
        db.alter_column(u'firestation_firedepartment', 'fdid', self.gf('django.db.models.fields.CharField')(default='VA', max_length=10))

        # Changing field 'FireDepartment.created'
        db.alter_column(u'firestation_firedepartment', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
        # Adding unique constraint on 'FireDepartment', fields ['fdid', 'state']
        db.create_unique(u'firestation_firedepartment', ['fdid', 'state'])


    def backwards(self, orm):
        # Removing unique constraint on 'FireDepartment', fields ['fdid', 'state']
        db.delete_unique(u'firestation_firedepartment', ['fdid', 'state'])
        ...
        # Changing field 'FireDepartment.fdid'
        db.alter_column(u'firestation_firedepartment', 'fdid', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'FireDepartment.created'
        db.alter_column(u'firestation_firedepartment', 'created', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'firestation.firedepartment': {
            'Meta': {'unique_together': "(('fdid', 'state'),)", 'object_name': 'FireDepartment'},
