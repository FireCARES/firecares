...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NFIRSStatistic'
        db.create_table(u'firestation_nfirsstatistic', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('fire_department', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['firestation.FireDepartment'])),
        ...
        db.send_create_signal(u'firestation', ['NFIRSStatistic'])


    def backwards(self, orm):
        # Deleting model 'NFIRSStatistic'
        db.delete_table(u'firestation_nfirsstatistic')
    ...
    models = {
        ...
        u'firestation.nfirsstatistic': {
            'Meta': {'object_name': 'NFIRSStatistic'},
