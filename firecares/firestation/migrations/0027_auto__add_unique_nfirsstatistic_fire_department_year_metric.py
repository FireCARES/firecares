...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'NFIRSStatistic', fields ['fire_department', 'year', 'metric']
        db.create_unique(u'firestation_nfirsstatistic', ['fire_department_id', 'year', 'metric'])


    def backwards(self, orm):
        # Removing unique constraint on 'NFIRSStatistic', fields ['fire_department', 'year', 'metric']
        db.delete_unique(u'firestation_nfirsstatistic', ['fire_department_id', 'year', 'metric'])
    ...
    models = {
        ...
        u'firestation.nfirsstatistic': {
            'Meta': {'unique_together': "(['fire_department', 'year', 'metric'],)", 'object_name': 'NFIRSStatistic'},
