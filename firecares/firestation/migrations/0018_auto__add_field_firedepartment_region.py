...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FireDepartment.region'
        db.add_column(u'firestation_firedepartment', 'region',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FireDepartment.region'
        db.delete_column(u'firestation_firedepartment', 'region')
