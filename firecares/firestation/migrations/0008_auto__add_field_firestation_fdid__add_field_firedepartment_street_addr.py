...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FireStation.fdid'
        db.add_column(u'firestation_firestation', 'fdid',
    ...
    def backwards(self, orm):
        # Deleting field 'FireStation.fdid'
        db.delete_column(u'firestation_firestation', 'fdid')
