...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FireDepartment.created'
        db.add_column(u'firestation_firedepartment', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 3, 7, 0, 0)),
                      keep_default=False)

        # Adding field 'FireDepartment.modified'
        db.add_column(u'firestation_firedepartment', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 3, 7, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FireDepartment.created'
        db.delete_column(u'firestation_firedepartment', 'created')

        # Deleting field 'FireDepartment.modified'
        db.delete_column(u'firestation_firedepartment', 'modified')
