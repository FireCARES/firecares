...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FireDepartment.object_id'
        db.alter_column(u'firestation_firedepartment', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'FireDepartment.content_type'
        db.alter_column(u'firestation_firedepartment', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'FireDepartment.object_id'
        raise RuntimeError("Cannot reverse this migration. 'FireDepartment.object_id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'FireDepartment.object_id'
        db.alter_column(u'firestation_firedepartment', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')())

        # User chose to not deal with backwards NULL issues for 'FireDepartment.content_type'
        raise RuntimeError("Cannot reverse this migration. 'FireDepartment.content_type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'FireDepartment.content_type'
        db.alter_column(u'firestation_firedepartment', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType']))
