...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FireDepartment.dist_model_score'
        db.add_column(u'firestation_firedepartment', 'dist_model_score',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FireDepartment.dist_model_score'
        db.delete_column(u'firestation_firedepartment', 'dist_model_score')
