...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FireStation.state_or_territory'
        db.add_column(u'firestation_firestation', 'state_or_territory',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['usgs.StateorTerritoryHigh'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FireStation.state_or_territory'
        db.delete_column(u'firestation_firestation', 'state_or_territory_id')
    ...
    models = {
        ...
        u'firestation.firestation': {
            ...
            'state_or_territory': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['usgs.StateorTerritoryHigh']", 'null': 'True', 'blank': 'True'}),
