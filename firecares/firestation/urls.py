...
urlpatterns = patterns('',
                       url(r'departments/(?P<pk>\d+)/(?P<slug>[-\w]+)/similar$', FireDepartmentListView.as_view(template_name='firestation/firedepartment_list.html'), name='similardepartments_list_slug'),
                       url(r'departments/(?P<pk>\d+)/similar$', FireDepartmentListView.as_view(template_name='firestation/firedepartment_list.html'), name='similardepartments_list'),
