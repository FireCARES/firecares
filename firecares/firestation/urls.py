from .views import (DepartmentDetailView, Stats, FireDepartmentListView, FireDepartmentFavoriteListView,
                    FireStationFavoriteListView, SimilarDepartmentsListView, DepartmentUpdateGovernmentUnits,
                    FireStationDetailView, DownloadShapefile, DocumentsView, DocumentsFileView, DocumentsDeleteView)
...
urlpatterns = patterns('',
                       ...
                       url(r'^departments/favorites?$', FireDepartmentFavoriteListView.as_view(template_name='firestation/firedepartment_favorite_list.html'), name='firedepartment_favorite_list'),
