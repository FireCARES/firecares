...
from .views import LimitedRegistrationView, ChooseDepartmentView, VerifyAssociationRequest, RegistrationPreregisterView

urlpatterns = patterns('',
                       url(r'^registration-check/$',
                           RegistrationPreregisterView.as_view(),
